  ...
  _createClass(IndecisionApp, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(Action, { hasOptions: options.length > 0, onPick: this.onPick }),
        React.createElement(Options, { options: options, onRemoveAll: this.onRemoveAll }),
      ...
      return React.createElement(
        ...
        options.length > 0 ? React.createElement(
          ...
          options.map(function (option, i) {
            return React.createElement(Option, { key: i + 1, option: option });
          })
        ) : React.createElement(
          'p',
          null,
